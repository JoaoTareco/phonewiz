...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "relative h-[34rem] flex items-center bg-white dark:bg-black justify-center w-full group",
        containerClassName
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block pb-0   px-1 rounded-xl bg-gradient-to-r from-[#e21c4a8d] to-[#f05ed389]`,
        className
      )}
    >
      {children}
